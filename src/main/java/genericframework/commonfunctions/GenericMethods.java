...
public class GenericMethods {
	...
	private final GenericApiMethods genericApiMethods;
	/**
	 ...
	 * All the utilities available in the genericframework will be instantiate as part of
	 * this. <br>
	 * Below is the list of utilities available in genericframework
	 * <ul>
	 ...
	 */
	public GenericMethods(String screenShotsPath, LogAccess logAccess, String downloadFolderPath) {
		...
		genericApiMethods = new GenericApiMethods(logAccess);
	...
	public String getScreenShotTime() {
		return dateTimeUtil.getCurrentDateTime(GenericCommonVariables.TIME_FORMATS[8]);
	}
	...
	public WebElement waitForElement(WebDriver driver, WebElement element, ExpectedConditionsEnums expectedCondition)
			throws Exception {
		return waitForElement(driver, element, expectedCondition, GenericCommonVariables.MED_TIMEOUT, true);
	}
	...
	public WebElement waitForElement(WebDriver driver, WebElement element, ExpectedConditionsEnums expectedCondition, boolean isScrollElementToCenter)
		...
		return waitUntilElement(driver, element, expectedCondition, GenericCommonVariables.MED_TIMEOUT,isScrollElementToCenter);
	}
	...
	public WebElement waitForElement(WebDriver driver, By byLocator, ExpectedConditionsEnums expectedCondition)
		...
		return waitUntilElement(driver, byLocator, expectedCondition, GenericCommonVariables.MED_TIMEOUT);
	}
	...
	public WebElement waitForElement(WebDriver driver, By byLocator, ExpectedConditionsEnums expectedCondition, boolean isScrollElementToCenter)
		...
		this.logAccess.getLogger()
				.debug("waiting for element to be " + expectedCondition.toString() + " :- " + byLocator);
		return waitUntilElement(driver, byLocator, expectedCondition, GenericCommonVariables.MED_TIMEOUT, isScrollElementToCenter);
	}
	 ...
	 * {@link GenericCommonVariables#MIN_TIMEOUT} before checking for element invisibility.
	 *
	 * @param driver     the {@link org.openqa.selenium.WebDriver WebDriver}
	 * @param element    the {@link org.openqa.selenium.WebElement element}
	 * @param maxTimeout the max timeout in seconds
	...
	public boolean waitForInvisibilityOfElement(WebDriver driver, WebElement element, int maxTimeout) throws Exception {
		return waitForInvisibilityOfElement(driver, element, GenericCommonVariables.MIN_TIMEOUT, maxTimeout);
	}
	...
	public boolean waitForInvisibilityOfElement(WebDriver driver, WebElement element, int initialWaitTime, int maxTimeout) throws Exception {
		...
		try {
			...
			do {
				...
				isElementVisible = isElementPresent(driver, element, GenericCommonVariables.NO_TIMEOUT);
	...
	public boolean waitForInvisibilityOfElement(WebDriver driver, By byLocator, int maxTimeout) throws Exception {
		return waitForInvisibilityOfElement(driver, byLocator, GenericCommonVariables.MIN_TIMEOUT, maxTimeout);
	}
	...
	public boolean waitForInvisibilityOfElement(WebDriver driver, By byLocator, int initialWaitTime, int maxTimeout)
		...
		try {
			do {
				...
				isElementVisible = isElementPresent(driver, byLocator, GenericCommonVariables.NO_TIMEOUT);

				if (isElementVisible) {
					// Checking if element is visible though it is in the DOM.
					isElementVisible = isElementDisplayed(driver, byLocator, GenericCommonVariables.NO_TIMEOUT);
				}
				Thread.sleep(500);
			} while ((new Date()).getTime() < endTimestamp && isElementVisible);
		} catch (NoSuchElementException | StaleElementReferenceException ignoreException) {
	...
	public boolean isElementPresent(WebDriver driver, WebElement element) {
		...
		try {
			WebElement targetEle = waitForElement(driver, element, ExpectedConditionsEnums.PRESENCE, GenericCommonVariables.MED_TIMEOUT);
	...
	public boolean isElementPresent(WebDriver driver, By byLocator) {
		...
		// specified time
		try {
			WebElement targetEle = waitForElement(driver, byLocator, ExpectedConditionsEnums.PRESENCE, GenericCommonVariables.MED_TIMEOUT);
	...
	public boolean isElementDisplayed(WebDriver driver, By byLocator) {
		return isElementDisplayed(driver, byLocator, GenericCommonVariables.MED_TIMEOUT, true);
	}
	...
	public boolean isElementDisplayed(WebDriver driver, By byLocator, boolean isScrollElementToCenter) {
		return isElementDisplayed(driver, byLocator, GenericCommonVariables.MED_TIMEOUT, isScrollElementToCenter);
	}
	...
	public boolean isElementDisplayed(WebDriver driver, WebElement element) {
		return isElementDisplayed(driver, element, GenericCommonVariables.MED_TIMEOUT, true);
	}
	...
	public boolean isElementDisplayed(WebDriver driver, WebElement element, boolean isScrollElementToCenter) {
		return isElementDisplayed(driver, element, GenericCommonVariables.MED_TIMEOUT, isScrollElementToCenter);
	}
	...
	public boolean isElementEnabled(WebDriver driver, WebElement element) {
		return isElementEnabled(driver, element, GenericCommonVariables.MED_TIMEOUT);
	 ...
	 * This method will keep checking for max of {@link GenericCommonVariables#MED_TIMEOUT}
	 * seconds<
	 *
	 * @param driver    the {@link org.openqa.selenium.WebDriver WebDriver}
	 * @param byLocator the by locator
	...
	public boolean isElementEnabled(WebDriver driver, By byLocator) throws Exception {
		...
		return isElementEnabled(driver, byLocator, GenericCommonVariables.MED_TIMEOUT);
	}
	...
	public void clickOnElement(WebDriver driver, WebElement element, boolean isCaptureScreenShot, boolean captureBefore,
		...
		clickOnElement(driver, element, isCaptureScreenShot, captureBefore, screenShotName, GenericCommonVariables.MED_TIMEOUT);
	}
	...
	public void clickOnElement(WebDriver driver, By byLocator, boolean isCaptureScreenShot, boolean captureBefore,
							   String screenShotName) throws Exception {
		clickOnElement(driver, byLocator, isCaptureScreenShot, captureBefore, screenShotName, GenericCommonVariables.MED_TIMEOUT);
	}
	...
	public void inputValue(WebDriver driver, By byLocator, String value, boolean isCaptureScreenshot,
						   String screenShotName) throws Exception {
		inputValue(driver, byLocator, value, isCaptureScreenshot, screenShotName, GenericCommonVariables.MED_TIMEOUT);
	}
	...
	public void selectItemByIndex(WebDriver driver, WebElement element, int index, boolean isCaptureScreenshot,
								  String screenShotName) throws Exception {
		selectItemByIndex(driver, element, index, isCaptureScreenshot, screenShotName, GenericCommonVariables.MED_TIMEOUT);
	}
	...
	public void selectItemByValue(WebDriver driver, WebElement element, String value, boolean isCaptureScreenshot,
								  String screenShotName) throws Exception {
		selectItemByValue(driver, element, value, isCaptureScreenshot, screenShotName, GenericCommonVariables.MED_TIMEOUT);
	}
	...
	public void selectItemByVisibleText(WebDriver driver, WebElement element, String visibleText,
		...
		selectItemByVisibleText(driver, element, visibleText, isCaptureScreenshot, screenShotName, GenericCommonVariables.MED_TIMEOUT);
	}
	...
	public void selectItemByPartialVisibleText(WebDriver driver, WebElement element, String partialVisibleText,
											   boolean isCaptureScreenshot, String screenShotName) throws Exception {
		selectItemByPartialVisibleText(driver, element, partialVisibleText, isCaptureScreenshot, screenShotName, GenericCommonVariables.MED_TIMEOUT);
	}
	...
	public String getText(WebDriver driver, WebElement element, boolean isCaptureScreenShot, String screenShotName)
			throws Exception {
		return getText(driver, element, isCaptureScreenShot, screenShotName, GenericCommonVariables.MED_TIMEOUT);
	}
	...
	public String getText(WebDriver driver, By byLocator, boolean isCaptureScreenShot, String screenShotName)
			throws Exception {
		return getText(driver, byLocator, isCaptureScreenShot, screenShotName, GenericCommonVariables.MED_TIMEOUT);
	}
	...
	public String captureScreenShotWithHighlight(WebDriver driver, WebElement element, String screenshotName)
		...
		//if (!GenericCommonVariables.IS_RUNNING_ON_SBOX) {
	...
	public String waitUntilDownloadCompleted(WebDriver driver, int maxTimeoutInSeconds, SessionId sessionId) throws Exception {
		...
		try {
			...
			if (GenericCommonVariables.BROWSER_SELECT.equalsIgnoreCase("chrome")) {
			...
			} else if (GenericCommonVariables.BROWSER_SELECT.equalsIgnoreCase("firefox")) {

				// navigate to Firefox downloads
				driver.get("about:downloads");
				//Thread.sleep(GenericCommonVariables.MIN_TIMEOUT);
			...
			}else if (GenericCommonVariables.BROWSER_SELECT.equalsIgnoreCase("edge")) {
			...
			if (GenericCommonVariables.EXEC_PLATFORM.equalsIgnoreCase("docker")) {
	...
	public List<WebElement> getElements(WebDriver driver, By byLocator) {
		return getElements(driver, byLocator, GenericCommonVariables.MED_TIMEOUT);
