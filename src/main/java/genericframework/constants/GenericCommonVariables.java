package genericframework.constants;

import java.io.File;
import java.util.HashMap;

/**
 * All the common variables related to the genericframework.
 */
public class GenericCommonVariables {
    ...
    public static void setRemoteWdHubUrl(String remoteWdHubUrl) {
        GenericCommonVariables.remoteWdHubUrl = remoteWdHubUrl;
    }
    ...
    public static void setRemoteWdHubToken(String remoteWdHubToken) {
        GenericCommonVariables.remoteWdHubToken = remoteWdHubToken;
    }
    ...
    public static void setExecutionPlatform(String executionPlatform) {
        GenericCommonVariables.executionPlatform = executionPlatform;
    }


    public static final String EXEC_PLATFORM = getExecutionPlatform();

    public static final String HOST_ADDRESS = GenericCommonVariables.EXEC_PLATFORM.equals("docker")? "http://localhost:4444": getRemoteWdHubUrl();
