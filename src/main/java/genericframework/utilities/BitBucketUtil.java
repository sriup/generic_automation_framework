...
import genericframework.commonfunctions.GenericApiMethods;
import genericframework.enums.ContentTypesEnums;
...
public class BitBucketUtil {
    ...
    public void createBranch(String sourceBranch, String newBranchName){
        ...
        GenericApiMethods genericApiMethods = new GenericApiMethods(this.logAccess);
        ...
        Response response = genericApiMethods.sendRequest("post", uri, headers,ContentTypesEnums.MULTIPART_FORMDATA, data);
    ...
    public String createPullRequest(String sourceBranch, String targetBranch){
        ...
        Response response = genericApiMethods.sendRequest("post", uri, headers, payload);
        ...
        this.prNumber =  genericApiMethods.getValue(response, "id");
