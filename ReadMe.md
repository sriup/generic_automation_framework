...
1. Generate AES_KEY - Run the [Generate AES_KEY](src/test/java/unittests/encryption/GenerateAesKey.java) file to generate the AES_KEY
2. Store it in the user environment variable as AES_KEY.
   ![AES_KEY.png](AES_KEY.png)
3. Run the [Encrypt Data](src/test/java/unittests/encryption/Encrypt.java) file to encrypt the data.
4. Run the [Decrypt Data](src/test/java/unittests/encryption/Decrypt.java) file to decrypt the data.
</details>
...
Fork the project [on Github](https://placeholder/link/reponame)
